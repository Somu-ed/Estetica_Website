...
<head>
	...
	<title>Projects | Estetica Furnishing</title>
        ...
        <div class="container wide">
            ...
            <div class="row">
                ...
                <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-6 mb-sm-50">
                    ...
                    <div class="about-page-text">
                        <p class="subtitle subtitle--deep">ESTETICA</p>
                        <h1>Customised Fabric Design</h1>
        ...
        <div class="container wide">
            ...
            <div class="row">
                ...
                <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-6 mb-sm-50">
                    ...
                    <div class="about-page-text">
                        <p class="subtitle subtitle--deep">ESTETICA</p>
                        <h1>Lawn Grass Carpet Installation</h1>
        ...
        <div class="container wide">
            ...
            <div class="row">
                ...
                <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-6 mb-sm-50">
                    ...
                    <div class="about-page-text">
                        <p class="subtitle subtitle--deep">ESTETICA</p>
                        <h1>Government Guest House Suites at Puri</h1>
        ...
        <div class="container wide">
            ...
            <div class="row">
                ...
                <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-6 mb-sm-50">
                    ...
                    <div class="about-page-text">
                        <p class="subtitle subtitle--deep">ESTETICA</p>
                        <h1>Panthanivas Refurbishing at BBSR</h1>
                        <p class=" mb-35">We got this project through one of our associate architect and a very good friend, who has a furniture factory in Bhubaneswar. This is a guest house project with more than 45 rooms, which is being done on phase manner. We, from Estetica supplied the soft furnishing which included Mattress, Mattress Protector, Bed Sheet, Pillow, Pillow Case, Comforter, Comforter Cover, bed runner, cushions with cushion covers, face towel, bath towel along with roman blind. The minimalistic interiors were suitably supported by our elegant furnishing.</p>
                    </div>
