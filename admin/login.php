...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Estetica | Admin Login</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: rgb(246,231,228)">
					<!--begin::Aside Top-->
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						<!--begin::Aside header-->
						<a href="#" class="text-center mb-10">
							<img src="assets/media/login/logo_login.png" class="max-h-70px" alt="" />
						</a>
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #333333;">Discover Amazing Estetica
						<br />with great build tools</h3>
						<!--end::Aside title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(assets/media/login/login_illustration.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
						...
						<div class="login-form login-signin">
							...
							<form class="form" >
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Estetica</h3>
									<span class="text-muted font-weight-bold font-size-h4">Hello admin!
									<a class="text-danger font-weight-bolder">Log in to your Account</a></span>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Email</label>
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="email" id="email" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
								...
								<div class="pb-lg-0 pb-5">
									<button type="button" id="submit" class="btn btn-danger font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 sweet_al">Sign In</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
						...
						<div class="login-form login-forgot">
							...
							<form class="form" novalidate="novalidate" id="kt_login_forgot_form">
								...
								<div class="form-group d-flex flex-wrap pb-lg-0">
									<button type="button" id="kt_login_forgot_submit" class="btn btn-danger font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Submit</button>
									<button type="button" id="kt_login_forgot_cancel" class="btn btn-light-danger font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</button>
								</div>
								<!--end::Form group-->
							</form>
							<!--end::Form-->
