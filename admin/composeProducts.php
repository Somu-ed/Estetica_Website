	...
	$(document).ready(function() {
		...
		$('#add').click(function() {
			...
			if(name == "" || category == "" || files.length == 0 ){
				...
				console.log(fd, name, category, files);
				...
				$.ajax({
					...
					success:function(response){
						if(response == 1){
							...
							window.location = "composeProducts.php";
						});
...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Products - Compose | Estetica Admin</title>
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Products - Compose</h5>
									<!--end::Page Title-->
									<!--begin::Actions-->
											...
											<form method="post" class="form" enctype="multipart/form-data">
												<div class="card-body">
													<div class="form-group row">
														<div class="col-lg-6">
															<label>Display Name <span style="color: #F64E60;">*<span></label>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                            <label for="category">Category <span style="color: #F64E60;">*<span></label>
