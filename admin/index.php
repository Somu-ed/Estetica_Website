...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Dashboard | Estetica Admin</title>
											...
											<div class="col-xl-8">
												...
												<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-danger bg-custom" style="height: 250px; background-image: url(assets/img/home/blog1.png)">
													<div class="card-body d-flex">
														<div class="d-flex py-5 flex-column align-items-start flex-grow-1">
															<div class="flex-grow-1">
																<a href="composeBlog" class="text-white font-weight-bolder font-size-h2">Compose Blog</a>
																<p class="text-white opacity-75 font-weight-bold mt-3">Fill the details and submit to add a new blog.</p>
															</div>
															<a href='composeBlog' class="btn btn-link btn-link-white font-weight-bold">View
															<span class="svg-icon svg-icon-lg svg-icon-white">
																<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												...
												<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary bg-custom" style="height: 250px; height: 250px; background-image: url(assets/img/home/prod.png)">
													...
													<div class="card-body d-flex">
														<div class="d-flex py-5 flex-column align-items-start flex-grow-1">
															...
															<a href='composeProducts' class="btn btn-link btn-link-white font-weight-bold">View
															<span class="svg-icon svg-icon-lg svg-icon-white">
																<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
