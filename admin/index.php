    ...
    <div class="wrapper">
        ...
        <header class="navbar navbar-fixed">
            ...
            <div class="navbar--header">
                ...
                <a href="index.php" class="logo">
                    <img style="display: block; margin-left: auto; margin-right: auto; height:45px;" src="assets/img/navbar_white.png" alt="">
                </a>
                <!-- Logo End -->
        ...
        <main class="main--container">
            ...
            <footer class="main--footer main--footer-light">
                <p>Copyright &copy; <a href="#">Perfect Shades</a>. All Rights Reserved.</p>
            </footer>
            <!-- Main Footer End -->
        </main>
        <!-- Main Container End -->
