						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="row">
									...
									$brand_query = "SELECT * FROM clients".$sWhere;
									...
									while ($brand = mysqli_fetch_array($brand_fire)) {
                                        ...
                                        <div class='card card-custom gutter-b card-stretch'>
                                            ...
                                            <div class='d-flex' style='justify-content: center;'>
                                                ...
                                                <div class='symbol symbol-50 symbol-lg-120' style='margin-bottom: 20px;'>
                                                    <img
                                                    style='object-fit: cover;'
                                                    alt='Pic'
                                                    src='../assets/images/clients/$brand_img'
                                                    />
												</div>
												<form>
													<button class='btn btn-block btn-sm btn-light-danger font-weight-bolder text-uppercase py-4 delete' id='$brand_id' type='button' >Delete</button>
												</form>
                                                <div
								...
								<div class="card card-custom">
									<div class="card-body py-7">
										...
										$query = "SELECT * FROM clients".$sWhere;
										...
										if($page>1){
											echo"
											<a href='postedClients?page=1' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
												<i class='ki ki-bold-double-arrow-back icon-xs'></i>
											</a>
											<a href='postedClients?page=".$prev.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
										...
										for($i=1; $i<=$total_pages; $i++){
											if($i == $page){
												echo"
												  <a href='postedClients?page=".$i.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm border-0 btn-hover-primary active mr-2 my-1'>".$i."</a>
												";
											}
											else{
												echo"
												  <a href='postedClients?page=".$i.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm border-0 btn-hover-primary mr-2 my-1'>".$i."</a>
												";
											}
										}
										if($page == $total_pages){
											...
											$next = $page+1;
											echo"
											<a href='postedClients?page=".$next.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
												<i class='ki ki-bold-arrow-next icon-xs'></i>
											</a>
											<a href='postedClients?page=$total_pages' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
