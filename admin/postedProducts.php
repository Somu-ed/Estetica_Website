...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Posted Products | Estetica</title>
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Posted Products</h5>
									<!--end::Page Title-->
									<!--begin::Actions-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="row">
									...
									$fetch = "SELECT * FROM products".$sWhere;
                                        ...
                                        <div class='card card-custom gutter-b card-stretch'>
                                            ...
                                            <div class='d-flex img-dir'>
                                                ...
                                                <div class='symbol symbol-50 symbol-lg-120 img-pd'>
                                                    ...
                                                    alt='Pic'
                                                    src='../assets/images/products/$prod_img'
                                                    />
                                                </div>
                                                <div
								...
								<div class="card card-custom">
									<div class="card-body py-7">
										...
										if($page>1){
											echo"
											<a href='postedProducts?page=1' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
												<i class='ki ki-bold-double-arrow-back icon-xs'></i>
											</a>
											<a href='postedProducts?page=".$prev.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
										...
										for($i=1; $i<=$total_pages; $i++){
											if($i == $page){
												echo"
												  <a href='postedProducts?page=".$i.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm border-0 btn-hover-primary active mr-2 my-1'>".$i."</a>
												";
											}
											else{
												echo"
												  <a href='postedProducts?page=".$i.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm border-0 btn-hover-primary mr-2 my-1'>".$i."</a>
												";
											}
										}
										if($page == $total_pages){
											...
											$next = $page+1;
											echo"
											<a href='postedProducts?page=".$next.(!empty($aPath)?'&'.$aPath:'')."' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
												<i class='ki ki-bold-arrow-next icon-xs'></i>
											</a>
											<a href='postedProducts?page=$total_pages' class='btn btn-icon btn-sm btn-light-danger mr-2 my-1'>
										...
										<form action='postedProducts' method='post' id='form'>
